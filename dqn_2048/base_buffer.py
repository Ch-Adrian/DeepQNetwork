...
class BaseReplayBuffer(ABC):
    ...
    def add(self, buffer_state: dict, experience: tuple, idx: int):
        ...
        buffer_state["action_masks"] = buffer_state["action_masks"].at[idx].set(action_mask)
        ...
        buffer_state["new_action_masks"] = buffer_state["new_action_masks"].at[idx].set(new_action_mask)
